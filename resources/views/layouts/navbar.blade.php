<nav class="bg-white shadow-sm py-4 px-20">
    <div class="container mx-auto flex justify-between items-center px-4">
        ...
        <ul class="flex space-x-6 text-sm text-gray-700">
            ...
            <li><a href="#" class="hover:text-white font-medium hover:bg-orange-500 transition duration-200 p-2 rounded-md">Tarif Listrik</a></li>
        </ul>
        <div class="space-x-2">
