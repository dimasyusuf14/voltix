{{--  resources/views/admin/metode/create.blade.php  --}}
@extends('admin.index')
...
@section('content')
    ...
    <div class="bg-white shadow rounded-lg p-6">
        <!-- Header -->
        <div class="mb-6">
            <h2 class="text-xl font-bold text-gray-800 mb-1">Tambah Metode Pembayaran</h2>
        ...
        <form action="{{ route('metode.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" id="biaya_admin" name="biaya_admin" value="{{ old('biaya_admin') }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div>
                ...
                <textarea id="deskripsi" name="deskripsi" rows="3"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    placeholder="Deskripsi metode pembayaran...">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
