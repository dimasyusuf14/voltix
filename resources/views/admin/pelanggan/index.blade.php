                ...
                <tr>
                    ...
                    <td class="border align-middle">
                        <div class="flex flex-row gap-2 items-center justify-center">
                            ...
                            <!-- Tombol Hapus -->
                            <form action="{{ route('admin.pelanggan.destroy', $pelanggan->id_pelanggan) }}" method="POST" class="m-0 p-0">
                                @csrf @method('DELETE')
                                <button type="submit"
        ...
        <script>
            $(document).ready(function() {
                ...
                table.buttons().nodes().each(function(value, index) {
                    $(this).removeClass('dt-button').addClass('bg-blue-600 text-white px-3 py-1 rounded text-sm hover:bg-blue-700 transition');
                });
            });
        </script>
    </div>
