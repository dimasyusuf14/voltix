...
<div class="bg-white p-6 rounded shadow max-w-xl mx-auto">
    ...
    <form action="{{ route('admin.pelanggan.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_pelanggan" placeholder="Nama lengkap" value="{{ old('nama_pelanggan') }}" class="w-full border rounded px-4 py-2">
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nomor_kwh" value="{{ $nomor_kwh }}" class="w-full border rounded px-4 py-2 bg-gray-100 text-gray-600" readonly>
        </div>
