    ...
    <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-xl relative">
        ...
        <form id="editTagihanForm" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="meter_awal" id="edit_meter_awal" class="w-full border px-3 py-2 rounded" required>
            </div>

            {{-- Meter Akhir --}}
            <div class="mb-4">
                <label for="edit_meter_akhir" class="block text-sm font-medium mb-1">Meter Akhir</label>
                <input type="number" name="meter_akhir" id="edit_meter_akhir" class="w-full border px-3 py-2 rounded" required>
            </div>

            {{-- Tombol --}}
            <div class="flex justify-between items-center mt-6">
                <button type="button" onclick="closeEditTagihanModal()" class="text-gray-600 hover:underline">Batal</button>
