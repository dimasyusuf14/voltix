    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="flex-1 space-y-4">
                {{-- Kartu Riwayat 1 --}}
                <div class="bg-white rounded-xl shadow p-6 flex flex-col md:flex-row justify-between items-start md:items-center">
                    <div class="space-y-1">
                    ...
                    <div class="text-right space-y-1 mt-4 md:mt-0">
                        ...
                        <p class="text-sm text-gray-600">Daya Listrik<br><span class="text-blue-600 font-semibold">6600 VA ke atas</span></p>
                    </div>
